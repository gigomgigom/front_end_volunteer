        ...
        <div class="card-body" style="padding: 12px;">
            ...
            <div class="row_container mt-3 mb-3" v-for="(vol) in volList" :key="vol.no">
                ...
                <div class="row" style="font-size: 14px;">
                    ...
                    <div class="col-sm-2 ">
                        <button class="" style="display: inline-block; margin-bottom: 4px; border: none; border-radius: 4px; margin-left: 25px; font-size: 16px; width: 81.63px;" @click="emit('showModal')">추가</button>
                    </div>
                </div>
                <div class="row" style="font-size: 14px; ">
                    <div class="col-sm-12 " style="padding: 0;">
